...
type ProjectController struct {
	...
	projectsGetUseCase usecases.ProjectsGetUseCase
}

func NewProjectController(projectService *services.ProjectService, projectsGetUseCase usecases.ProjectsGetUseCase) *ProjectController {
